...
//
// Commands:
//   hubot talk - Begin session with the Robotic Rogerian Therapist
//   hubot stop talking - End session
//
//
// Author:
...
module.exports = function (robot) {
    ...
    robot.respond(/talk$/i, function (msg) {
    ...
    robot.respond(/stop talking$/i, function (msg) {
        ...
        if (eliza) {
            ...
            msg.reply("Sorry, but there is no running Talking session.");
        }
    });
